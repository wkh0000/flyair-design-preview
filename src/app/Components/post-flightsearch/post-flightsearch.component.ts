...
@Component({
  selector: 'app-post-flightsearch',
  standalone: true,
  ...
  imports: [
    ...
    MatTooltipModule,
    FormsModule,
  ],  templateUrl: './post-flightsearch.component.html',
  styleUrl: './post-flightsearch.component.scss'
})
export class PostFlightsearchComponent implements OnInit {
  @HostListener('document:click', ['$event'])
  @Output() closeAccordion = new EventEmitter<void>(); // EventEmitter to notify parent
  ...
  initializeForms() {
    ...
    this.oneWayForm.patchValue(this.payload);
    ...
    this.returnForm.patchValue(this.payload);
  }
